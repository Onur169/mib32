...
class ImageManipulator
{
    ...
    const LARGE_ALLIANCES_IMAGE_WIDTH = 263;
    const LARGE_ALLIANCES_IMAGE_HEIGHT = 183;
    const MEDIUM_ALLIANCES_IMAGE_WIDTH = 240;
    const MEDIUM_ALLIANCES_IMAGE_HEIGHT = 130;
    const SMALL_ALLIANCES_IMAGE_WIDTH = 220;
    const SMALL_ALLIANCES_IMAGE_HEIGHT = 130;
